...
mkdir -p cases/your-case-slug/filings
```
...
- id: 2025-01-15-complaint
  ...
  type: Filing
  title: Complaint
  file: /cases/your-case-slug/filings/2025-01-15_Filing_Complaint.pdf
...
- id: 2025-02-01-answer
  ...
  type: Filing
  title: Answer
  file: /cases/your-case-slug/filings/2025-02-01_Filing_Answer.pdf
```

### 6. Upload Documents

Place PDF files in `cases/your-case-slug/filings/` following naming convention:
```
